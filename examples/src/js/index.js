  ...
  var getReorderComponent = function (React, ReactDOM, createReactClass) {
    ...
    return createReactClass({
      ...
      itemDown: function (item, index, event) {
        // console.log("itemdown", item,index,event);
      ...
      render: function () {
        ...
        var getPropsTemplate = function (item, extras) {
          ...
          // }
          // if (parent) {
          //   console.log("props", index, parent);
          //   p.mouseDownRelay = self.listDown;
          //   p.itemDownRelay = self.itemDown.bind(self, item, index)
          // }
            
          // if (self.props.template) {
          //   return React.createElement(self.props.template, p);
          // }
          // return item;
        ...
        var list = this.state.list.map(function (item, index) {
          ...
          return React.createElement(self.props.wrapperElement ? self.props.wrapperElement : 'div', {
            key: itemKey,
            className: itemClass,
        ...
        return React.createElement(this.props.wrapperElement ? this.props.wrapperElement : 'div', {
